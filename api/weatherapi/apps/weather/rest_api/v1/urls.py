...
from weatherapi.apps.weather.rest_api.base.views.fetch_weather_forecasts import (
    fetch_weather_data,
)
...
urlpatterns = [
    path("fetch-weather-forecasts", fetch_weather_data, name="fetch-weather-data-ep"),
    path(
