...
DEBUG = env.bool("WEATHERAPI_DEBUG")

ALLOWED_HOSTS = env.list("WEATHERAPI_ALLOWED_HOSTS", default=[])

SECRET_KEY = env.str("WEATHERAPI_SECRET_KEY")
...
INSTALLED_APPS = [
    ...
    "weatherapi.apps.weather.apps.WeatherConfig",
] + env.list("WEATHERAPI_DEV_INSTALLED_APPS", default=[])
...
DATABASES = {"default": env.db("WEATHERAPI_DATABASE_URL")}
...
SESSION_COOKIE_SECURE = env.bool("WEATHERAPI_SESSION_COOKIE_SECURE", default=True)
